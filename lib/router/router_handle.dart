...
import 'package:base_bloc/modules/tab_tournament/tab_tournament.dart';
import 'package:base_bloc/modules/tournament_detail/tournament_detail_page.dart';
...
var routeTabRace = Handler(handlerFunc: (c, p) => const TabTournament());
...
var routeTournamentDetail = Handler(
    handlerFunc: (c, p) => TournamentDetailPage(
